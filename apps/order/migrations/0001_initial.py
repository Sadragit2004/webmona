    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'پرداخت نشده'), (2, 'پرداخت شده'), (3, 'تایید شده'), (4, 'تحویل شده'), (6, 'تمدید نشده'), (5, 'تمدید شده')], default=1, verbose_name='وضعیت سفارش')),
